...
functions.http('cropVideoFunction', async (req, res) => {
	const body = req.body;
	const request = {
				...
				"inputs": [
					{
						...
						"preprocessingConfig": {
							"crop": {
								"topPixels": body.topPixels,
								"bottomPixels": body.bottomPixels,
								"leftPixels": body.leftPixels,
								"rightPixels": body.rightPixels
							}
						}
					}
				],
