...
export default function Dashboard() {
    ...
    return <div class="relative overflow-x-auto mx-auto mt-4 w-11/12">
        <button type="button" onClick={()=>{
            router.push("/jobs");
        }} class="ml-2 float-end text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">All Jobs</button>
        <button type="button" onClick={()=>{
